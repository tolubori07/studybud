...
def update_room(request,pk):
    ...
    if request.user != room.host :
        return HttpResponse("SILENCE BUFFOON! YOU ARE NOT PERMITTED TO EDIT THIS ROOM AS YOU ARE NOT THE OWNER!")
    if request.method == 'POST':
        topic_name = request.POST.get('topic')
        topic, created = Topic.objects.get_or_create(name=topic_name)
...
def delete_room(request,pk):
    room = Room.objects.get(id = pk)
    if request.user != room.host :
        return HttpResponse("SILENCE BUFFOON! YOU ARE NOT PERMITTED TO DELETE THIS ROOM AS YOU ARE NOT THE OWNER!")
    if request.method == 'POST':
        room.delete()
        return redirect('home')
